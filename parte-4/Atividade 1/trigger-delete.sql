...
GO
IF OBJECT_ID ('Contents.TGR_Score_AD','TR') IS NOT NULL
    DROP TRIGGER Contents.TGR_Score_AD;
GO

CREATE TRIGGER Contents.TGR_Score_AD
...
BEGIN
    ...
    SELECT @Data_Delivary = delivary_date, @ID_Class_Student = id_course_class_student, @ID_Activity = id_activity FROM DELETED
